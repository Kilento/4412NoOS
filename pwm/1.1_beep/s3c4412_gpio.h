...
#define GPK1CON (*(volatile unsigned long*)(GPIOBASE1 + 0x0060))
#define GPK1DAT (*(volatile unsigned long*)(GPIOBASE1 + 0x0064))
#define GPK1PUD (*(volatile unsigned long*)(GPIOBASE1 + 0x0068))
#define GPK1DRV (*(volatile unsigned long*)(GPIOBASE1 + 0x006C))

#define GPL2CON (*(volatile unsigned long*)(GPIOBASE1 + 0x0100))
#define GPL2DAT (*(volatile unsigned long*)(GPIOBASE1 + 0x0104))
#define GPL2PUD (*(volatile unsigned long*)(GPIOBASE1 + 0x0108))
#define GPL2DRV (*(volatile unsigned long*)(GPIOBASE1 + 0x010C))
...
#define GPD0CON (*(volatile unsigned long*)(GPIOBASE2 + 0x00A0))
#define GPD0DAT (*(volatile unsigned long*)(GPIOBASE2 + 0x00A4))
#define GPD0PUD (*(volatile unsigned long*)(GPIOBASE2 + 0x00A8))
#define GPD0DRV (*(volatile unsigned long*)(GPIOBASE2 + 0x00AC))

#define EXT_INT41_CON (*(volatile unsigned long*)(GPIOBASE1 + 0x0E04))
#define EXT_INT42_CON (*(volatile unsigned long*)(GPIOBASE1 + 0x0E08))
#define EXT_INT43_CON (*(volatile unsigned long*)(GPIOBASE1 + 0x0E0C))
