...
void key_init(void)
{
    ...
    */
    ...
    EXT_INT41CON = 0x00000220; // 设置引脚 GPX1_1 and GPX1_2 中断为下降沿模式
    EXT_INT42CON = 0x00000022; // 设置引脚 GPX2_0 and GPX2_1 中断为下降沿模式
    EXT_INT43CON = 0x00002000;   // 设置引脚 GPX3_3 中断为下降沿模式
